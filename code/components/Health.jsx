  ...
  return (
    ...
    <div className='health-form'>
      <div className='health-top'>
        <h1>Build your <lable>health</lable> plan,<br/> your way</h1>
        <p>Customise and create your own health insurance</p>
      </div>
    ...
    <Link to="/services/health/form" className='link'> <button className='apply'>Apply now</button></Link>
