  ...
  return (
    ...
    <div className='health-form'>
      <div className='health-top'>
        <h1>"Life Insurance that <lable>Grows</lable> with You <br/>and <lable>Protects</lable> What Matters"  </h1>
        <p>Customise and create your own Whole life insurance</p>
      </div>
    ...
    <Link to="/services/wholelife/form" className='link'> <button className='apply'>Apply now</button></Link>
